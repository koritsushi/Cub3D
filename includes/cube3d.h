...
/*   Updated: 2025/10/09 15:05:01 by mliyuan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_cub
{
	// location of player1
	t_pt		p1;
	// direction (0-360) that p1 is facing. 
	// east is 0, numbers increase anti-clockwise 
	// (follow trig)	
	float		dir_angle;
	// use this for point translation
	t_pt		dir_pt;
	int			mfwd;
	int			mback;
	int			mleft;
